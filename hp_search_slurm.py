...
parser.add_argument('--model', choices=['resnet_mfcc', 'resnet_lstm', 'resnet_qrnn', 'resnet_stats', 'resnet_large', 'resnet_small', 'se_resnet', 'TDNN', 'transformer', 'all'], default='resnet_mfcc', help='Model arch according to input type')
...
model=instru.var.OrderedDiscrete(['resnet_mfcc', 'resnet_lstm', 'resnet_qrnn', 'resnet_stats', 'inception_mfcc', 'resnet_large', 'resnet_small', 'TDNN', 'transformer']) if args.model=='all' else args.model
ncoef=args.ncoef
epochs=args.epochs
