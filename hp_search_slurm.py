...
parser.add_argument('--model', choices=['resnet_mfcc', 'resnet_34', 'resnet_lstm', 'resnet_qrnn', 'resnet_stats', 'resnet_large', 'resnet_small', 'resnet_2d', 'se_resnet', 'TDNN', 'TDNN_mod', 'transformer', 'aspp_res', 'pyr_rnn', 'all'], default='resnet_mfcc', help='Model arch according to input type')
...
model=instru.var.OrderedDiscrete(['resnet_mfcc', 'resnet_34', 'resnet_lstm', 'resnet_qrnn', 'resnet_stats', 'inception_mfcc', 'resnet_large', 'resnet_small', 'resnet_2d', 'TDNN', 'TDNN_mod', 'transformer', 'aspp_res', 'pyr_rnn']) if args.model=='all' else args.model
ncoef=args.ncoef
epochs=args.epochs
...
instrum=instru.Instrumentation(lr, l2, momentum, margin, lambda_, patience, swap, latent_size, n_frames, model, ncoef, epochs, batch_size, valid_batch_size, n_workers, cuda, train_hdf_file, valid_hdf_file, slurm_sub_file, tmp_dir, checkpoint_path, softmax, delta)
