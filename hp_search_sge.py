...
model=instru.var.OrderedDiscrete(['resnet_mfcc', 'resnet_lstm', 'resnet_stats', 'inception_mfcc', 'resnet_large', 'resnet_small', 'TDNN', 'transformer']) if args.model=='all' else args.model
ncoef=args.ncoef
epochs=args.epochs
