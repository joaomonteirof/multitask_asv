...
class ResNet(nn.Module):
	def __init__(self, block, num_blocks, sm_type, num_classes=1000):
...
def ResNet18(sm_type='softmax'):
	return ResNet(PreActBlock, [2,2,2,2], sm_type)

def ResNet34(sm_type='softmax'):
	return ResNet(PreActBlock, [3,4,6,3], sm_type)

def ResNet50(sm_type='softmax'):
	return ResNet(PreActBottleneck, [3,4,6,3], sm_type)

def ResNet101(sm_type='softmax'):
	return ResNet(PreActBottleneck, [3,4,23,3], sm_type)

def ResNet152(sm_type='softmax'):
	return ResNet(PreActBottleneck, [3,8,36,3], sm_type)
